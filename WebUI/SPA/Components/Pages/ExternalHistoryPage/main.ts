...
import { ExternalHistoryPageModule } from './external-history-page.module';
...
if (module.hot) {
    ...
    module.hot.dispose(() => {
        ...
        const oldRootElem = document.querySelector('external-history-page');
        const newRootElem = document.createElement('external-history-page');
...
//customChangeDetectionZone.run(() => {
    modulePromise = platformBrowserDynamic().bootstrapModule(ExternalHistoryPageModule);
//});